...
async function getMedia(deviceId) {
    // deviceId 가 없을 때 실행 (camera 만들기 전)
...
// Socket Code
    // peerA 브라우저가 offer를 만들고 전송
socket.on("welcome", async () => {
    myDataChannel = myPeerConnection.createDataChannel("chat");
    myDataChannel.addEventListener("message", (data) => {console.log(data);});
    ...
    // peerB 브라우저가 offer를 받아서 remoteDescription을 설정
...
function makeConnection() {
    myPeerConnection = new RTCPeerConnection({
        iceServers: [{
            ...
            username: "oE-CVBsxymydYjkiJA4vE4brcIQzqbI4wUdHjzLTZvhHFO0iIhNiZnrHR8PeE-y4AAAAAGNRIvVzdXV1dXV1YQ==",
            credential: "086960f0-5062-11ed-9534-0242ac120004",
            urls: [
